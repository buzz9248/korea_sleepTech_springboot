...
public class CommentServiceImpl implements CommentService {
    ...
    * */
    public ResponseDto<CommentRespDto> createComment(Long postId, CommentCreateReqDto dto) {
    ...
    @Transactional
    // 1번 게시물, 3번 댓글 수정
    public ResponseDto<CommentRespDto> updateComment(Long postId, Long commentId, CommentUpdateReqDto dto) {
        CommentRespDto respDto = null;

        D_Comment comment = commentRepository.findById(commentId).orElseThrow(() -> new EntityNotFoundException(ResponseMessage.NOT_EXISTS_COMMENT + commentId));
