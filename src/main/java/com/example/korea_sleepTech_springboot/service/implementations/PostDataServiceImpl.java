...
public class PostDataServiceImpl implements PostDataService {
    ...
    @Override
    public ResponseDto<PostRespDto> createPost(PostReqDto dto, MultipartFile file) throws IOException {
        PostRespDto data = null;
        ...
        if (file != null && !file.isEmpty()) {
            saveFile(file, post.getId(), "POST"); // 파일 저장
        }
